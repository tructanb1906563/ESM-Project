<template>
    ...
    >
        <div class="flex flex-col items-center min-w-fit">
            ...
            <div
                v-if="this.isEdit"
                class="flex justify-center mb-4 items-center"
            >
                <input
                    type="file"
                    class="hidden"
            ...
            <div v-show="this.isAvatarUploading" class="w-36 mb-4">
                <div class="mb-1 text-base font-medium text-green-500">
                    Uploading...
                </div>
        ...
        <div class="flex flex-col px-8 py-10 w-full">
            ...
            <div
                ...
                class="flex sm:flex-row 2xs:flex-col items-center"
                :class="{
                    'md:flex-col lg:flex-row justify-evenly': this.isEdit,
                }"
            >
                <textarea
                    type="description"
...
export default {
    ...
    methods: {
        ...
        async saveEdit() {
            if (!validateProfileEdit(this.form)) return
            await axios
                .put('/users/' + this.user._id + '/edit', {
        ...
        uploadAvatar() {
            ...
            axios
                .post('/users/' + this.user._id + '/avatar', formData, {
                    headers: {
                ...
                .then((res) => {
                    if (res.status == 200) {
                        this.$notify({
                            type: 'success',
                            text: 'Successfully uploaded avatar.',
                        })
