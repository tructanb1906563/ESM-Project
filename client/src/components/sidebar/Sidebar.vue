<template>
    <div
        class="sidebar md:flex flex-col md:flex-row md:min-h-screen md:relative opacity-75 shadow-lg"
    >
        <div
        ...
        >
            ...
            >
                <SidebarLink to="/" icon="home" @click="notOpen"
                    >Home</SidebarLink
                >
                <SidebarLink to="/profile" icon="user" @click="notOpen"
                    >Profile</SidebarLink
                >

                <SidebarLink to="" icon="sign-out-alt" @click="logout"
                    >Logout</SidebarLink
                >
            </nav>
        </div>
